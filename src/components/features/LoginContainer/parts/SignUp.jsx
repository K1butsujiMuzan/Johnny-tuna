      ...
      <>
        <div className={styles.confirmation}>
          <div className={styles.linkContainer}>
            <span className={styles.linkForm} onClick={backToForm}>
              Назад
            </span>
          </div>
          <div className={styles.confirmationDown}>
            <p className={styles.confirmationText}>
              ...
              <span className={styles.accent}>{formData.email}!</span> Перейдите
              по ссылке в письме для подтверждения аккаунта.
            </p>
            <SubmitButton>
              <Link
                to={'/'}
      ...
      <div className={styles.mainFormUp}>
        <div className={styles.errorBlock}>
          <p className={styles.error}>
            {errorsState.loginError || errorsState.serverError}
          </p>
          <LoginInput
            type={'text'}
            minLength={3}
